...
static const std::unordered_set<std::string> MODE_OPTION_SPECIFIERS { "--mode", "-m" };

/* Adds execution time at the end of output. */
static const std::unordered_set<std::string> TIME_OPTION_SPECIFIERS { "--time", "-t" };

/* "Only result" mode outputs for each graph only whether the graph is or is not MED-colorable (yes/no answer). */
static const std::unordered_set<std::string> ONLY_RESULT_MODE_SPECIFIERS { "onlyresult", "only-result", "result", "r", "or" };

/* "Not colorable" mode outputs numbers of graphs that are not MED-colorable. */
static const std::unordered_set<std::string> NOT_COLORABLE_MODE_SPECIFIERS { "notcolorable", "not-colorable", "n", "nc" };

/* "Not colorable bridgeless" mode outputs numbers of graphs that are not MED-colorable and also bridgeless. */
static const std::unordered_set<std::string> NOT_COLORABLE_BRIDGELESS_MODE_SPECIFIERS { "notcolorablebridgeless", "not-colorable-bridgeless", "b", "ncb" };
...
static const std::unordered_set<std::string> COLORING_MODE_SPECIFIERS { "coloring", "c" };
